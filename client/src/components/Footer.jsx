...
<footer class="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70">
    <div class="flex items-center gap-8">
        ...
        <a href="/about" class="font-medium text-gray-500 hover:text-black transition-all">
            About
        </a>
        <a href="#tools" class="font-medium text-gray-500 hover:text-black transition-all">
            Services
        </a>
        <a href="#" class="font-medium text-gray-500 hover:text-black transition-all">
            Contact
    ...
    <p class="mt-8 text-center">Copyright © 2025 <a href="https://www.linkedin.com/in/nikhil-kurane25">Nikhil Kurane</a>. All rights reservered.</p>
</footer>
    )
}